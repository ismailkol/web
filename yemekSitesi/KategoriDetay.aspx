        ...
        <table class="auto-style8">
            <tr>
                <td class="auto-style10"><a href="YemekDetay.aspx?Yemekid=<%#Eval("Yemekid")%>">
                    <asp:Label ID="Label3" runat="server" Font-Size="13pt" Text='<%# Eval("YemekAd") %>' ForeColor="Red"></asp:Label>
                    </a></td>
            </tr>
            <tr>
                <td>Malzemeler: 
                    <asp:Label ID="Label4" runat="server" Font-Size="13pt" Text='<%# Eval("YemekMalzeme") %>' ForeColor="Black"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>Yemek Tarifi: 
                    <asp:Label ID="Label5" runat="server" Font-Size="13pt" Text='<%# Eval("YemekTarif") %>' ForeColor="Black"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>Eklenme Tarihi: 
